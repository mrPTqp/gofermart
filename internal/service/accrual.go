...
func (s *AccrualServiceImpl) ProcessOrders(ctx context.Context) {
...
func (s *AccrualServiceImpl) processOrder(ctx context.Context, order model.Order) error {
